...
- Go 1.26.2+ is required (for standard library security patches). Run `make deps` to install dependencies and Go tools, then `make ci-local` to mirror CI locally.
